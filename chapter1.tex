...
In this chapter, first, we learn about the risks associated with banking. Then we will discuss Asset Liability Management (ALM) a solution over risk associated with banking and ALM for banks. Then we will discuss project objectives and problem statement. Then a glance over banking standards and the literature survey.\cite{}

\section{Risks Associated with Banking}

The term risk can be defined in association with banking as the exposure of to loss.  The several risks associated with banking are viz.,

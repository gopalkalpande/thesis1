...
\thispagestyle{empty}
    ...
    \bf \Large{Master of Technology}\\in\\ \bf \Large{Artificial Intelligence}\\ \\ By\\ \bf{Gopal Kumar Kalpande}\\ \bf{17MCMI10}\\ \\
...
%----------------------------------------------------------Main Matter-----------------------------------------------------------------	
	...
	\chapter{Background and Related Literature}
	\input{chapter2.tex}
	
	\chapter{Proposed Algorithms for Overlapping Community Discovery}
	\input{chapter3.tex}
